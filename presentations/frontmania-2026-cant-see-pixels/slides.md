...
info: |
  ...
  Frontmania 2026 · Tim Damen · Focusring
...
No throat-clearing, no bio (Frontmania intros speakers). One breath on the title, then straight into the persona on the next slide.
