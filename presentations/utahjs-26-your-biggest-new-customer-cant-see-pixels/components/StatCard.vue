...
<template>
  <div class="stat-card">
    ...
    <div class="stat-source"><a v-if="href" :href="href" target="_blank" rel="noopener noreferrer">{{ source }}</a><template v-else>{{ source }}</template><template v-if="date"> · {{ date }}</template></div>
  </div>
</template>
